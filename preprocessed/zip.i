    ...
    int in, out;
{
    ...
    { { if (outcnt < 16384 -2) { outbuf[outcnt++] = (uch) (((stamp) & 0xffff) & 0xff); outbuf[outcnt++] = (uch) ((ush)((stamp) & 0xffff) >> 8); } else { {outbuf[outcnt++]=(uch)((uch)(((stamp) & 0xffff) & 0xff)); if (outcnt==16384) flush_outbuf();}; {outbuf[outcnt++]=(uch)((uch)((ush)((stamp) & 0xffff) >> 8)); if (outcnt==16384) flush_outbuf();}; } }; { if (outcnt < 16384 -2) { outbuf[outcnt++] = (uch) ((((ulg)(stamp)) >> 16) & 0xff); outbuf[outcnt++] = (uch) ((ush)(((ulg)(stamp)) >> 16) >> 8); } else { {outbuf[outcnt++]=(uch)((uch)((((ulg)(stamp)) >> 16) & 0xff)); if (outcnt==16384) flush_outbuf();}; {outbuf[outcnt++]=(uch)((uch)((ush)(((ulg)(stamp)) >> 16) >> 8)); if (outcnt==16384) flush_outbuf();}; } }; };
