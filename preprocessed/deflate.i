...
# 84 "deflate.c" 2
# 138 "deflate.c"
_Static_assert (4096 < (0x8000 -(258 +3 +1)), "verify (" "RSYNC_WIN < MAX_DIST" ")");
# 147 "deflate.c"
typedef ush Pos;
...
static off_t deflate_fast()
{
    ...
    while (lookahead != 0) {
        ...
        if (flush) flush_block(block_start >= 0L ? (char*)&window[(unsigned)block_start] : (char*)
# 730 "deflate.c" 3 4
                  ((void *)0)
# 730 "deflate.c"
                  , (long)strstart - block_start, flush-1, (0)), block_start = strstart;
